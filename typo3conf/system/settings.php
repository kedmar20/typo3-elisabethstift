...
return [
    'BE' => [
        'debug' => false,
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$dK5SK8bB8uW8vTocNT4oFQ$uXu96PsdDHGvtdHT7zRrvTXsHyY5cCpaVVjrK4N6Bcc',
        'passwordHashing' => [
    ...
    'MAIL' => [
        'transport' => 'sendmail',
        'transport_sendmail_command' => '/usr/sbin/sendmail -fsupport@typografix.de -t -i',
    ...
    'SYS' => [
        ...
        'devIPmask' => '',
        'displayErrors' => 0,
        'encryptionKey' => '5c2410228779edf40d29cda2192807d94cfd827e21dc5cf901ea8f24493572453a5b6cc2d8320cce46ddddd5f55bec95',
