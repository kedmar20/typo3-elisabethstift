 ...
 * SubmenuProvider
 */
class SubmenuProvider implements IconProviderInterface
{
    /**
     * @return string
     */
    ...
    {
        return 'EXT:bootstrap_package/Resources/Public/Images/Icons/Submenu/';
    }
    ...
    {
        return 'EXT:bootstrap_package/Resources/Public/Images/Icons/Submenu/' === $identifier;
    }
    ...
    public function getIconList(): IconList
    {
        ...
        $directory = 'EXT:bootstrap_package/Resources/Public/Images/Icons/Submenu/';
