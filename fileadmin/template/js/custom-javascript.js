...
const linkInMenuAngebote = document.querySelector(
  "#mainnavigation .navbar-nav #nav-item-3"
);
linkInMenuAngebote ? linkInMenuAngebote.setAttribute("href", "#") : "";
/*********************************************************************************************/
/*Suchergebnis - wechseln innerText durch Weiterlesen*/
const linkElemSuchergebnisPath = document.querySelectorAll(
  "#p12 .custom-path-suchergebnis-li > a"
);
if (!!linkElemSuchergebnisPath) {
  linkElemSuchergebnisPath.forEach((el) => {
    el.innerText = "Weiterlesen";
  });
}
/*********************************************************************************************/
